...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left side - Decorative Financial Background */}
      <div
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="mt-1 text-sm outline-none border border-[#DDDDDD] p-2 w-full rounded-[8px] focus:outline-none focus:shadow-[0_0_8px_rgba(16,185,129,0.3)] focus:ring-0 transition-all duration-500"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    value={user.password}
                    onChange={handleChange}
                    className="mt-1 text-sm outline-none border border-[#DDDDDD] p-2 w-full rounded-[8px] focus:outline-none focus:shadow-[0_0_8px_rgba(16,185,129,0.3)] focus:ring-0 transition-all duration-500 pr-10"
